...
// Exercises the function the extension itself uses, rather than a copy of it.
const apply = (text) => {
    const applied = applyShortenPlan(text);

    return { result: applied.text, plan: applied.plan };
};
